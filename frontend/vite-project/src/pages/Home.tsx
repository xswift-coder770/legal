...
//                     AI Powered Legal Policy Summarizer & RAG Assistant
//                 </p>
...
//                                     <p className="text-5xl mt-4 text-purple-400">

//                                         {analysisData.analysis.riskScore}/100
...
//                                 <div className="bg-[#1e293b] rounded-2xl p-6 md:col-span-2">
...
//     const riskScore: number | undefined = analysisData?.analysis?.riskScore;
